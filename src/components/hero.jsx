...
export default function Hero() {
  ...
  const TerminalVisual = () => (
    <div className="w-96 h-64 bg-gray-900 rounded-xl p-6 font-mono text-sm">
      ...
      <div className="space-y-2">
        ...
        <div className="text-white">
          spending hours picking a font 
        </div>
        <div className="text-green-400">$ git pull</div>
        <div className="text-white">
          research in progress_
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-row justify-center content-center gap-25 pt-50">
        <div className=''>
            <h1 className="pb-6 text-3xl lg:text-6xl font-medium ">
            Nishna Aerabati
            </h1>
